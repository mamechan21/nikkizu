...
class NikkisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nikki" do
    assert_difference('Nikki.count') do
      post nikkis_url, params: { nikki: { article: @nikki.article, category: @nikki.category, user: @nikki.user } }
    end
  ...
  test "should update nikki" do
    patch nikki_url(@nikki), params: { nikki: { article: @nikki.article, category: @nikki.category, user: @nikki.user } }
